...
#Open VideoSplitter in your IDE of choice (e.g., Spyder). Run the script with command line options filling in the appropriate video file with the full directory and choosing the increments you want in seconds. Eg., to split the P002.mp4 video file into 5s chunks:
#video splitter
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 23 11:52:34 2019
